...
write-host "`nTo import the New-NAVCrmTable cmdlet for use, type`n"
write-host -fore Yellow "Import-NAVCrmModule`n"

# Add a new module to export the Import-NAVCrmModule function
New-Module -ScriptBlock {
    function Import-NAVCrmModule {
        $moduleCrm = Import-Module (Join-Path $PSScriptRoot 'Model.Tools.Crm\Microsoft.Dynamics.Nav.Model.Tools.Crm.psd1') -DisableNameChecking -PassThru -Global
        if ($moduleCrm)
        {
            Get-Command -Module $moduleCrm
        }
    }
    Export-ModuleMember -Function Import-NAVCrmModule
} | Out-Null

# SIG # Begin signature block
# MIInzAYJKoZIhvcNAQcCoIInvTCCJ7kCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhTH2G6IiOjl32
# 4of8O2iF5l/h5RXiEinD0OKiK3w3qqCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgyiWMeeot
# 1p2iQBnLTK7TbsBtf3e9b7zgF1PyTKLDvBMwZAYKKwYBBAGCNwIBDDFWMFSgNoA0
...
# ggEAe/xGlVwaT0Gv/0h90aWdWvzScUuHYvabngf7TX+IqvmKNlU3oj7dc2vNSCOY
# ma9dAdrNHXZGUqmc4ZIz1bT1AY3qTmoD6kqQ2je2s6b3bXji4yodAB/aa6A+eeVv
# Qj6rNSfGZQ8BeZ2RWW/OxDAZzNs80Mc8hjvDwf/TmTFbQxgbYaN2t7GCqUgazM8Z
# y2NedLRXMEJxD21jJ81F+oHbg/jdayn8vSjqsLSqhQlamK0xLz0P9ktt8qu5bDIh
# Urd0ohEfEdI2P9Nq9H9ah2JLIYoevBqqLUbUszyyhQNZjB3/7LiG+6vyaZVzvEEq
# 68iTFkmzk/B9SbjsVjmPw3snDaGCFwkwghcFBgorBgEEAYI3AwMBMYIW9TCCFvEG
...
# AQUABCA9JyqWROy3fpzffgWXLUMiQcjDFD/HjeA72tjbfgcoQQIGYoTJeQClGBMy
# MDIyMDUyNjA1MTcyNy45MzNaMASAAgH0oIHUpIHRMIHOMQswCQYDVQQGEwJVUzET
...
# KoZIhvcNAQEFBQACBQDmOSrzMCIYDzIwMjIwNTI2MDIyMzQ3WhgPMjAyMjA1Mjcw
# MjIzNDdaMHQwOgYKKwYBBAGEWQoEATEsMCowCgIFAOY5KvMCAQAwBwIBAAICC0Iw
# BwIBAAICEcYwCgIFAOY6fHMCAQAwNgYKKwYBBAGEWQoEAjEoMCYwDAYKKwYBBAGE
# WQoDAqAKMAgCAQACAwehIKEKMAgCAQACAwGGoDANBgkqhkiG9w0BAQUFAAOBgQA3
# 5E5fSiuPEBa8zecbXC3uC4mTzfATk3ZWxB1XU0tMSqSbULFu8jWScmtMxakey8/A
# x1LORVQUybBBhye2YaLB+hTL3Ayf2+vD5KZdkx5+U2a23whUwRojdokQeQZ7/FyN
# M7m635NouVZUdvEktdxi0ZdJMRF8b9Lh1iZS6kNJxTGCBA0wggQJAgEBMIGTMHwx
# CzAJBgNVBAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRt
# b25kMR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9yYXRpb24xJjAkBgNVBAMTHU1p
# Y3Jvc29mdCBUaW1lLVN0YW1wIFBDQSAyMDEwAhMzAAABpQDeCMRAB3FOAAEAAAGl
# MA0GCWCGSAFlAwQCAQUAoIIBSjAaBgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQw
# LwYJKoZIhvcNAQkEMSIEIB3Os3Dv6W/6A/XmcCpxOddP1GYZaW1nhv1a+Py4l7CP
...
# MjAxMAITMwAAAaUA3gjEQAdxTgABAAABpTAiBCBz3veHerx61bzsc9xrvUvbGZDT
# ZJ3h3yEA7b/9iRAnLDANBgkqhkiG9w0BAQsFAASCAgB7uUDcInco7fDH3k+xGn4c
# QCw+O5YvZbqZWsx8ho9Dv7XmcL4tjmXavSAd2guUdMCTjukSAQbtInGG2mBx/v54
# JxSLvYOmYsh2Cy69DNTM9eN6nzafIPRYNM7kc7VoC9CCKsDAQZoxTLoyNEdItSH3
# Msjf8BbqIuKsaameMrM4B5uRzpoHctQvImX7Ckt1INg581a+4eXZtHmzZ79cLdLl
# koczulZkOrDox9haLewUWY5bat6Kk2LgIUXwFbs2KolmIL8fUYokuLTZqx5xnxHY
# Qb6LqZZqnmQym6nn1xyyhdU9ZMl2cca/BbTB4RfF0a8vnVudlrwiE+9eEpVtpCfX
# A6xy9Ok3827p8FQaGcWO/vC1KaBEsKKBULngta6dQyH8dQeDpg8zoy7FKb8mA7gZ
# mx80F3znA7YfUjk6FAQ5h3T8E5Pddfjryh0p5AFHfyflNuLWYE5KoozFW9inV5ZF
# EeOlQjnLQflXCKc6nMecKHMdvbwT7YaWWOoERGocUUWHByegjRrNAA9bL+jWpSYo
# ncsB04D/qHv+9u0+0MUUasSJDlV2ryJxAE86Ef2rmg0BIVUbpoBHiOhq9CO0fXSF
# K3x9ZinExLLI78lewhTVNrZDQ8vdWfA1WEqPQWaqzIb9bVsTGPpdrEmqQf1Z8fxh
# 4neAR5Z8iSwJH5TM/KecNQ==
