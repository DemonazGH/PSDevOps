function Stop-EcsRstNavService {
    [CmdletBinding()]
    param(
    ...
    try {
        ...
        # Stopping NAV Server Instance
        Write-EcsRstOutput "Disconnecting active user sessions for Service Tier..."
        Write-EcsRstOutput "Stopping BC/NAV Server Instance"
        Write-EcsRstOutput ("========================================================")
        
        try {
            Stop-EcsDbcNavService -ServerInstance $bcServerInstance
        }
        catch {
            $errorMessage = $_
        ...
        Write-EcsRstOutput "BC/NAV Server Instance has been successfully stopped"
        Write-EcsRstOutput ("========================================================")
...
<## >
Stop-EcsRstNavService -restorePipelineID_arg 'AAA'
<##>